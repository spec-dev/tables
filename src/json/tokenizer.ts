...
export default class Tokenizer {
    ...
    public onToken(token: TokenType.RIGHT_BRACE, value: '}', offset: number): void
    public onToken(token: TokenType.LEFT_BRACKET, value: '[', offset: number): void
    public onToken(token: TokenType.RIGHT_BRACKET, value: ']', offset: number): void
    ...
    public onToken(token: TokenType.SEPARATOR, value: string, offset: number): void
